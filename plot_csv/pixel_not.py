...
cell_coor = pd.read_csv(f'/home/yanghl/zhushijia/model_new_zhu/model_tangram_test/plot_csv/{name}/{type}_cell_coordinates.csv')
print(cell_coor)
...
cell_coor['X'] = pixel_x
cell_coor['Y'] = pixel_y
cell_coor.to_csv(f'/home/yanghl/zhushijia/model_new_zhu/model_tangram_test/plot_csv/{name}/{type}_cell_coordinates.csv',index=False)
