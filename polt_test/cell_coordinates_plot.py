...
image_resize = 0.1
cell_coordinates_csv = pd.read_csv(f'/home/yanghl/zhushijia/data/ST image/{name}/cells_on_spot.csv',\
...
image = Image.open(f'/home/yanghl/zhushijia/data/ST image/{name}/CytAssist_FFPE_Mouse_Brain_Rep2_tissue_image.tif')
