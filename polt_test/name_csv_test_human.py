...
cluster_type_to_cell_csv = pd.read_csv('/home/yanghl/zhushijia/data/ST image/human/Wu_etal_2021_BRCA_scRNASeq/metadata.csv')
...
merged_df = pd.merge(sum_tensor, cluster_type_to_cell_csv, on='sc_name', how='right').dropna()
print(merged_df)
