...
python main.py --dataset Mouse_brain_hippocampus_STexpr_cellSegmentation --weight_name Mouse --tangram_epochs 40 --data_dir /home/ljc/CLIMA/datasets/
#@ human
# python postprocess_code/name_csv_test_human.py && python postprocess_code/cell_coordinates_plot_human.py && python final_res/pixel_not_human.py && Rscript R_plot/plot_sub_image.R
...
#@ section1
# python postprocess_code/name_csv_test.py && python postprocess_code/cell_coordinates_plot.py && Rscript R_plot/plot_sub_image.R
...
#@ Mouse_brain_hippocampus_STexpr_cellSegmentation
# python postprocess_code/name_csv_test.py && python postprocess_code/cell_coordinates_plot.py && python final_res/pixel_not.py && Rscript R_plot/plot_sub_image.R
